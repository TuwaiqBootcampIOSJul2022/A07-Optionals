...
func DailyMeals(meal:String) -> Meal?{
    return meals[meal]
}
print(DailyMeals(meal: "Dinner")) //nil
print(DailyMeals(meal: "Breakfast")) // optional meal
...
func checkMeal () -> [String:Any] {
    if let userLog = UserDefaults.standard.dictionary(forKey: "mealLog") {
        return userLog
    }else {
        return [:]
    }
