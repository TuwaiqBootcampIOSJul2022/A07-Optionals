...
func myMeals(mealType: String) -> Meal?{
    return meals[mealType]
 }

 print(myMeals(mealType: "Breakfast"))
 print(myMeals(mealType: "lunch"))
/*:
...
func checkMeal() -> [String: Any]{
     guard let mealLog = UserDefaults.standard.dictionary(forKey: "mealLog")
    else{
         return []()
        }
     return mealLog
