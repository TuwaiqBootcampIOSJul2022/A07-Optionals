...
print(logMeal(food: "Breakfast")!)
print(logMeal(food: "lunch"))
 ...
 */
func checkMeals()->[String: Any]{
    
    if let custmerLog = UserDefaults.standard.dictionary(forKey: "mealLog"){
        return custmerLog
