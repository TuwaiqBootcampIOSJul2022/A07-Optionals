...
func checkAge(givenAge: String)-> Int?{
    ...
    if let userAgeInt = Int(givenAge){
...
//    }
    ...
    if let itemInStock = stock[item], itemInStock > 0{
                return prices[item]
        }else{
            return nil
        }
...
print("Donuts:",checkItem(item: "Donuts"))
/*:
