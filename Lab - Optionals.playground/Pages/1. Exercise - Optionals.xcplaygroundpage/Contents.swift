...
//Error: 1. Exercise - Optionals.xcplaygroundpage:11:20: note: force-unwrap using '!' to abort execution if the optional value contains 'nil' let userAge: Int = Int(userInputAge)
...
print(userAge)
print("userAge's value is nil, because the string \"34e\" have 'e' could not be converted to a proper integer")
/*:
