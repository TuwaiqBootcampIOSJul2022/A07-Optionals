...
print("must be unwrapped to a value of type (Int) and we have 3 ways to unwrapped: 1-Force Unwrap , 2-Optional Binding, 3- Nil-coalescing")
let userAge :Int? = Int(userInputAge)
...
print(userAge!)
print("It can be a integer value or it can be nil")
/*:
